...
{
    public class SupplierInfoSearchResultViewModel : ViewModelBase
    {
        ...
        #endregion
        public SupplierInfoSearchResultViewModel()
        {
            this.sfGridColumns = new Columns();
            SetSfGridColumns("SupplierInfo");
            var a = new SupplierInfoSearchFilterData();
            var DataList = CommonFunctions.GetSupplierInfoSearchData(a).ToList();
            CollectionView = CollectionViewSource.GetDefaultView(DataList);
            rowDataCommand = new RelayCommand2(ChangeCanExecute);
        }
        public SupplierInfoSearchResultViewModel(SupplierInfoSearchFilterData Filter)
        {
            this.sfGridColumns = new Columns();
            SetSfGridColumns("SupplierInfo");
